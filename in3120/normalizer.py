...
class Normalizer(ABC):
    ...
    def canonicalize(self, buffer: str) -> str:
        ...
        """
        # The Unicode standard defines various normalization forms of a Unicode string, based on
        # the definition of canonical equivalence and compatibility equivalence. In Unicode, several
        # characters can be expressed in various way. For example, the character U+00C7 (LATIN CAPITAL
        # LETTER C WITH CEDILLA) can also be expressed as the sequence U+0043 (LATIN CAPITAL LETTER C)
